    ...
    return (
        ...
        >
          <img
            ...
            alt="Flowbite Logo"
          />
          <span className="hidden sm:block max-w-screen-xl self-center text-6xl font-semibold whitespace-nowrap dark:text-white">
            Quiz
            </span>
        </a>
            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-6 mt-8">Welcome!</h1>
